 ...
 *   5. Delegates translation to lib/translate-pair.js (TM → API → quality gate)
 *   6. Applies post-translation steps (terminology, script conversion)
 *   7. Writes updated locale files
 *   8. Saves updated hash manifest
 *   9. Delegates Docusaurus sync to lib/docusaurus-sync.js
 *  10. Delegates content sync to lib/content-sync.js
 *
 * Modes:
