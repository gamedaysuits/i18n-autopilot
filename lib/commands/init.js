 ...
 *   4. Content Translation — Hugo, Docusaurus, or none
 *   5. Confirm — review summary, write config, show next steps
 *
...
import { CONFIG_FILENAMES, DEFAULT_MODEL, DEFAULT_BATCH_SIZE, detectDocusaurus } from '../config.js';
...
async function stepLanguages(rl) {
  console.log('');
  console.log('  Step 1/5 — Languages');
  console.log('  ────────────────────────────────────────────────');
  console.log('');
...
async function stepMethod(rl, languages) {
  console.log('');
  console.log('  Step 3/5 — Translation Method');
  console.log('  ────────────────────────────────────────────────');
  console.log('');
...
async function stepRegisters(rl, languages) {
  ...
  console.log('');
  console.log('  Step 2/5 — Registers');
  console.log('  ────────────────────────────────────────────────');
  console.log('');
...
/**
 * Step 4: Content translation — Hugo, Docusaurus, or none.
 */
async function stepContent(rl, cwd) {
  console.log('');
  console.log('  Step 4/5 — Content Translation');
  console.log('  ────────────────────────────────────────────────');
  console.log('');
...
/**
 * Step 5: Confirm — show summary, write config, display next steps.
 */
async function stepConfirm(rl, config, envVars) {
  console.log('');
  console.log('  Step 5/5 — Confirm');
  console.log('  ────────────────────────────────────────────────');
  console.log('');
...
async function runInteractive(cwd) {
  ...
  try {
    ...
    // Step 5: Locales directory and format
