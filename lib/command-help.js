...
import { DEFAULT_OPENROUTER_MODEL, DEFAULT_TEMPERATURE } from './config.js';
...
const COMMAND_HELP = {
  ...
  fonts: {
    usage: 'i18n-rosetta fonts <subcommand> [options]',
    description: [
  ...
  tm: {
    usage: 'i18n-rosetta tm <subcommand> [options]',
    description: [
    ...
    examples: [
      ...
      'i18n-rosetta tm clear                  # Clear with confirmation',
  ...
  xliff: {
    usage: 'i18n-rosetta xliff <subcommand> [options]',
    description: [
    ...
    subcommands: [
      ...
      ['import <file>',      'Merge reviewed .xliff translations into locale files'],
    ],
    options: [
    ...
    examples: [
      ...
      'i18n-rosetta xliff export --locale ja --out ./review/   # Custom output dir',
  ...
  models: {
    usage: 'i18n-rosetta models --method <provider>',
    description: [
  ...
  verify: {
    usage: 'i18n-rosetta verify [options]',
    description: [
    ...
    examples: [
      ...
      'i18n-rosetta verify --warn-only            # Non-blocking verification',
