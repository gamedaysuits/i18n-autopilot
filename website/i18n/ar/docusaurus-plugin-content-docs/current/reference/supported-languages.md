...
هذه اللغات غير مدعومة من قبل خدمات الترجمة الآلية (MT) التجارية. يوفر rosetta الأدوات للمجتمعات اللغوية لبناء طرقهم الخاصة وفقاً لـ [مبادئ OCAP](https://mtevalarena.org/docs/community/low-resource-languages).
...
الأسلوب، والبنية التحتية للتدريب، ومحول نظام الكتابة، وأدوات التقييم للغة الكري للسهول تعمل جميعها، ولكن مسار الترجمة **لم يتم إصداره بعد**. نحن نعمل مع المجتمعات اللغوية وفقاً لـ [مبادئ OCAP](https://mtevalarena.org/docs/community/low-resource-languages) لضمان الجودة قبل الإصدار. راجع [دعم لغة محدودة الموارد](https://mtevalarena.org/docs/community/low-resource-languages) لمعرفة القصة الكاملة — وكيف يمكنك المساهمة.
:::
...
- [دعم لغة محدودة الموارد](https://mtevalarena.org/docs/community/low-resource-languages) — بناء طرق للغات غير المخدومة بشكل كافٍ