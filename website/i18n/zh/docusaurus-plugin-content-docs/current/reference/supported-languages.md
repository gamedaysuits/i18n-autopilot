...
| 🟠 | **API (Plugin)** | 社区托管的翻译流水线，通过 HTTP 提供服务。[兼容 OCAP](/docs/guides/low-resource-languages)。 | 因提供商而异 |
...
这些语言不受商业机器翻译 (MT) 服务的支持。rosetta 为语言社区提供了在 [OCAP 原则](/docs/guides/low-resource-languages)下构建自有方法的工具。
...
:::info 平原克里语正在积极开发中
平原克里语的语域、辅导基础设施、书写系统转换器和评估工具均已可用，但翻译流水线**尚未发布**。我们正在 [OCAP 原则](/docs/guides/low-resource-languages)下与语言社区合作，以确保发布前的质量。有关完整背景以及如何参与贡献，请参阅[支持低资源语言](/docs/guides/low-resource-languages)。
:::
...
- [支持低资源语言](/docs/guides/low-resource-languages) —— 为服务不足的语言构建方法