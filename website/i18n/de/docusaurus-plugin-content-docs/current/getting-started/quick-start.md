...
5. `.i18n-rosetta.lock` erstellen, um nachzuverfolgen, was übersetzt wurde
...
Automatisch übersetzen, wenn sich Ihre Quelldatei ändert:
...
- **[Übersetzungsmethoden](/docs/guides/translation-methods)** — Wählen Sie die richtige Methode
