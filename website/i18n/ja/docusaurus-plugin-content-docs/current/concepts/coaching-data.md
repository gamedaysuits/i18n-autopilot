...
規則は説明ではなく、**指示**として記述します。LLMは言語理論を解釈するよりも、指示に従う方が得意です。
...
LLMが間違えたり捏造したりしそうな**ドメイン固有の用語**に焦点を当てます。LLMがすでに処理できる一般的な単語を気にする必要はありません。アプリケーションのUIに固有の用語に集中してください。
...
- [低資源言語のサポート](https://mtevalarena.org/docs/community/low-resource-languages) — 実践的なコーチング
