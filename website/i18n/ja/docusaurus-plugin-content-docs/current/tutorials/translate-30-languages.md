...
:::info
`crk` のサポートは現在開発中です。ステータスと貢献のガイドラインについては、[低リソース言語のサポート](/docs/guides/low-resource-languages)を参照してください。
:::
...
- [低リソース言語のサポート](/docs/guides/low-resource-languages) — 幅広いMTカバレッジを持たない言語にコーチングデータを追加する