...
| **Length inflation** | Mas mahaba nang husto ang output kaysa sa source | `[GATE] length` |
...
- [Mga Translation Methods](/docs/guides/translation-methods) — mga methods na nagfi-feed papasok sa gate
