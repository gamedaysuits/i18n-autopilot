...
:::info
การรองรับ `crk` กำลังอยู่ระหว่างการพัฒนา — ดูสถานะและแนวทางการมีส่วนร่วมได้ที่ [Support a Low-Resource Language](/docs/guides/low-resource-languages)
:::
...
- [Support a Low-Resource Language](/docs/guides/low-resource-languages) — เพิ่มข้อมูลการโค้ชสำหรับภาษาที่ไม่มีการรองรับ MT อย่างครอบคลุม