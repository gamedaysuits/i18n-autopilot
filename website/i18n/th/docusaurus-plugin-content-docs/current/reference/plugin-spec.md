...
- [MT Evaluation](https://mtevalarena.org/docs/leaderboard/rules) — การทำ benchmark ให้กับ method เพื่อส่งขึ้น leaderboard
- [Support a Low-Resource Language](https://mtevalarena.org/docs/community/low-resource-languages) — กรณีการใช้งานสำหรับ community plugin