...
ดูเพิ่มเติม: [คู่มือสำหรับภาษาที่มีทรัพยากรน้อย](/docs/guides/low-resource-languages)
...
ดู [การสนับสนุนภาษาที่มีทรัพยากรน้อย](/docs/guides/low-resource-languages) สำหรับคำแนะนำการโฮสต์โดยชุมชนฉบับเต็ม และ [การให้บริการวิธีการแปลผ่าน API](/docs/guides/serving-a-method) สำหรับข้อกำหนดของ endpoint
:::
...
ปลั๊กอินที่พัฒนาและพิสูจน์แล้วใน [eval harness](/docs/eval/harness) สามารถติดตั้งได้โดยตรง — วิธีการที่คุณตรวจสอบความถูกต้องที่นั่นสามารถนำมาใช้งานที่นี่ได้ด้วยคำสั่ง `plugin install` เพียงคำสั่งเดียว ดู [การประเมิน MT](/docs/eval/) สำหรับเวิร์กโฟลว์การประเมินฉบับเต็ม
:::
...
- [การสนับสนุนภาษาที่มีทรัพยากรน้อย](/docs/guides/low-resource-languages)
