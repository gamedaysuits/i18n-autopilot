...
**พิสูจน์สิ** เครื่องมือ [eval harness](/docs/eval/harness) ที่มาคู่กันจะทำการ benchmark ทุก translation method ด้วยการให้คะแนนที่สามารถทำซ้ำได้และมีการระบุลายนิ้วมือ (fingerprinted) โดย [leaderboard](/leaderboard) จะติดตามทุกการส่งผลงาน
...
**เจาะลึกยิ่งขึ้น:**
- [Data Sovereignty](/docs/guides/data-sovereignty) — หลักการ OCAP, CARE และ Māori Data Sovereignty
- [สนับสนุนภาษาที่มีทรัพยากรน้อย (Support a Low-Resource Language)](/docs/guides/low-resource-languages) — ความท้าทายที่เป็นจุดเริ่มต้นของทั้งหมด
- [Cookbook: FST-Gated Pipeline](/docs/tutorials/fst-gated-pipeline) — สร้าง decomposition pipeline
- [การประเมิน MT (MT Evaluation)](/docs/eval/) — วิธีการทำงานของ harness และ leaderboard
