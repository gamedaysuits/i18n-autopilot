...
:::info
Hỗ trợ `crk` đang được phát triển — xem [Hỗ trợ ngôn ngữ ít tài nguyên](/docs/guides/low-resource-languages) để biết trạng thái và hướng dẫn đóng góp.
:::
...
- [Hỗ trợ ngôn ngữ ít tài nguyên](/docs/guides/low-resource-languages) — Thêm dữ liệu hướng dẫn cho các ngôn ngữ không có độ phủ MT (Dịch máy) rộng rãi