...
Rosetta sẽ kiểm tra xem chuỗi có khớp với một khóa cài đặt sẵn trong thẻ ngôn ngữ hay không. Nếu có, toàn bộ prompt register từ thẻ sẽ được sử dụng. Nếu không, chuỗi sẽ được sử dụng nguyên bản. Xem [Ngôn ngữ được hỗ trợ](/docs/reference/supported-languages#language-cards) để biết các cài đặt sẵn hiện có.
...
| Trường | Kiểu | Mô tả |
|-------|------|-------------|
| `register` | `string` | Hướng dẫn về phong cách/giọng văn. Có thể là một **khóa cài đặt sẵn** (ví dụ: `casual-tu`, `formal-hapsyo`) hoặc văn bản tùy chỉnh. Xem [Thẻ ngôn ngữ](/docs/reference/supported-languages#language-cards). |
...
- [Phương thức dịch](/docs/guides/translation-methods) — chọn và kết hợp các phương thức
