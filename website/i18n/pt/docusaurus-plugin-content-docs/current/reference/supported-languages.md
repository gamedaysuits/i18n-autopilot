...
Esses idiomas não são suportados por serviços comerciais de MT. O rosetta fornece as ferramentas para que as comunidades linguísticas criem seus próprios métodos sob os [princípios OCAP](https://mtevalarena.org/docs/community/low-resource-languages).
...
Consulte [Conlangs, Scripts e Ortografia](/docs/guides/conlangs-scripts-orthography) para requisitos de fonte PUA, limitações do Unicode e como adicionar o seu próprio.
...
O LLM fará a tradução usando seu conhecimento de treinamento do idioma. Definir um `register` oferece controle sobre o tom, a formalidade e as convenções ortográficas. Consulte [Configuração](/docs/getting-started/configuration) para obter detalhes.
...
Consulte [Contribuindo com um Language Card](https://github.com/gamedaysuits/i18n-rosetta) para ver a especificação completa, incluindo validação de campos e checklist de PR.
...
- [Apoie um Idioma de Baixos Recursos](https://mtevalarena.org/docs/community/low-resource-languages) — criação de métodos para idiomas sub-representados